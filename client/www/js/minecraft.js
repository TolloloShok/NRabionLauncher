...
class MinecraftRunner {
    ...
    run(options) {
        ...
        /*let mcprocess = child_process.spawn('java', ['-Xmx1024M',
            '-Djava.library.path=' + minecraftDirectory + '\\versions\\ForgeOptiFine 1.11\\natives',
            '-cp', minecraftDirectory + '\\libraries\\net\\minecraftforge\\forge\\1.11-13.19.1.2189\\forge-1.11-13.19.1.2189.jar;' + minecraftDirectory +
            '\\libraries\\net\\minecraft\\launchwrapper\\1.12\\launchwrapper-1.12.jar;' + minecraftDirectory +
            '\\libraries\\org\\ow2\\asm\\asm-all\\5.0.3\\asm-all-5.0.3.jar;' + minecraftDirectory +
            '\\libraries\\jline\\jline\\2.13\\jline-2.13.jar;' + minecraftDirectory +
            '\\libraries\\com\\typesafe\\akka\\akka-actor_2.11\\2.3.3\\akka-actor_2.11-2.3.3.jar;' + minecraftDirectory +
            ...
            '\\libraries\\com\\mojang\\authlib\\1.5.24\\authlib-1.5.24.jar;' + minecraftDirectory +
            '\\versions\\ForgeOptiFine 1.11\\ForgeOptiFine 1.11.jar',
            '-Dfml.ignoreInvalidMinecraftCertificates=true', '-Dfml.ignorePatchDiscrepancies=true', '-Dorg.lwjgl.opengl.Display.allowSoftwareOpenGL=true',
            '-XX:+UseConcMarkSweepGC', '-XX:+CMSIncrementalMode', '-XX:-UseAdaptiveSizePolicy',
            '-Xmn128M',
            'net.minecraft.launchwrapper.Launch',
            '--version', 'ForgeOptiFine 1.11',
            '--gameDir', minecraftDirectory,
            '--assetsDir', minecraftDirectory + '\\assets',
            '--assetIndex', '1.11',
            '--username', this.username, '--uuid', this.uuid, '--accessToken', this.accessToken,
            '--userType', 'mojang',
        ...
        mcprocess.on('close', options.onFinish)*/
    }
